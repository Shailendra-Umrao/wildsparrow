...
<body>
	...
	<table align="center" border="1em">
		...
		<tr align="center">
			...
			<td><a href="<c:url value="/zip/Offline_Windows.zip" />"> WildSparrow API-Diff Offline Tool (Windows)</a> <br> <a href="<c:url value="/zip/Offline_Linux.tar" />">WildSparrow API-Diff Offline Tool(Linux)</a>  </td>
		</tr>
	</table>
</body>
</html>